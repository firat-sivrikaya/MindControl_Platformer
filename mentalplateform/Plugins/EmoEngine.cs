...
public class EmoEngine
{
        ...
        while (EdkDll.IEE_EngineGetNextEvent(hEvent) == EdkDll.EDK_OK)
        {
            ...
            switch (eventType)
            {
                case EdkDll.IEE_Event_t.IEE_UserAdded:
                    UnityEngine.Debug.Log("User added");
                    OnUserAdded(args);
                    break;
    ...
    public static void errorHandler(Int32 errorCode)
    {
        ...
        switch (errorCode)
        {
            ...
            case EdkDll.EDK_GYRO_NOT_CALIBRATED:
                errorStr = "Gyro is not calibrated. Please stay still.";  // this is not a error. 
                break;
            ...
            case EdkDll.EDK_UNKNOWN_ERROR:
                ...
                break;
		default:
			UnityEngine.Debug.Log ("unknown error: " + errorCode.ToString ());
                errorStr = "Unknown error";
                break;
        }
    ...
    {
#if UNITY_ANDROID
	EdkDll.InitAndroidClass();
#endif
		EdkDll.Plugin_IEE_EmoInitDevice();
